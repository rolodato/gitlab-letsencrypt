...
LABEL \
      ...
      org.label-schema.docker.cmd="docker container run --rm rolodato/gitlab-letsencrypt --domain example.com --email info@example.com --repository https://gitlab.com/my-user/my-repo --token GITLAB_TOKEN" \
